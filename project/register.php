<?php
    ...
    $confirmationUrl = 'https://jerins.vercel.app/project/confirmation.php'; // Replace with a public URL
    $validationUrl = 'https://jerins.vercel.app/project/validation.php'; // Replace with a public URL
