<?php
    ...
    $confirmationUrl = 'https://jerins.netlify.app//confirmation.php'; // Replace with a public URL
    $validationUrl = 'https://jerins.netlify.app//validation.php'; // Replace with a public URL
